...
const { fetchAndStoreSocialData, SOCIAL_CITY_IDS, hasCookie } = await import('../src/social-scraper.js')
...
console.log('╚══════════════════════════════════════════════════════════╝\n')
console.log(`  微博模式: ${hasCookie() ? '✅ 桌面搜索（含历史日期 + 互动采样）' : '⚠️  移动API（近期 | 设 WEIBO_COOKIE 解锁历史）'}`)
